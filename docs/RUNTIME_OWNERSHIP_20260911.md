...
1. `live.js`
2. `delivery-workflow-v1.js`
3. `workflow-backend-safe-v1.js`
4. `communication-workspace-v1.js`
5. `resources-workspace-v2.js`
6. `library-workspace-v1.js`

`live.js` remains the shell/router/state owner but also contains older domain implementations. Several later modules override or intercept those behaviors.
...
5. Project creation creates project + initial roadmap + intended participant access atomically.
...
No structural refactor should be merged until the corresponding scenario is executable and passing.
