-- 4b4c / 2b2c — G2 Evidence Planner V0.9 — unified ref freshness
-- Date: 2026-09-14
...
create or replace function public.plan_idea_evidence_context_candidate_v9(
  p_idea_id uuid,
...
revoke all on function public.plan_idea_evidence_context_candidate_v9(
  uuid,bigint,text[],boolean
) from public,anon,authenticated;
grant execute on function public.plan_idea_evidence_context_candidate_v9(
  uuid,bigint,text[],boolean
) to service_role;

-- V0.9 invariants:
-- - V0.8 planner semantics are preserved;
-- - recompute V0.6 makes machine and direct-human supporting refs basis-current by the same rule;
-- - historical unscoped direct refs cannot silently satisfy G2;
-- - inflight work remains Requirement+basis scoped;
