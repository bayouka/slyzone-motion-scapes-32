-- 4b4c / 2b2c — G2 Evidence / Market recompute V0.4 FINAL CANDIDATE
-- Date: 2026-09-13
-- STATUS: COMPILE/ROLLBACK CANDIDATE ONLY — DO NOT APPLY AS A MIGRATION.
-- Requires: G0 resolver V0.3 + G2_FINAL_HELPERS_V0_1_AUTHORITY.
...
create or replace function public.recompute_idea_evidence_context_candidate_v4(
  p_idea_id uuid,
...
begin
  ...
  v_context:=public.recompute_idea_creation_redesign_candidate_v3(
...
revoke all on function public.recompute_idea_evidence_context_candidate_v4(uuid,bigint)
from public,anon,authenticated;
grant execute on function public.recompute_idea_evidence_context_candidate_v4(uuid,bigint)
to service_role;

-- Final candidate invariants:
-- - current structural context comes only from G0 resolver V0.3;
