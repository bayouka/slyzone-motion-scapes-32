...
if(index.indexOf("call-engine-v2.js?v=2.0.0")>index.indexOf("boot.js?build=522")) fail('Call Engine V2 must be loaded before boot');
...
console.log('call engine v2: OK (2.0.0)');
