...
if ([livePos, homePos, projectsPos, accessPos].some((pos) => pos < 0)) fail('missing boot module in V6 presentation chain');
if (!(livePos < homePos && homePos < projectsPos && projectsPos < accessPos)) {
  fail('Projects V6 owner must load after Home V6 and before domain workflow owners');
}
...
const requiredCss = [
  '.project-v6-card-flow',
  '.project-v6-card-step',
  '.project-v6-focus-strip',
  '.project-v6-focus-card',
  '.project-v6-trajectory-card',
