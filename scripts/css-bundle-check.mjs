...
let expected = `/* 4b4c legacy core bundle — generated in source order for V4.5.8
   Consolidates historical global layers while pruning rules proven shadowed or dead in the active runtime.
