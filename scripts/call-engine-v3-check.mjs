...
const migration=read('supabase/migrations/20260912013500_call_media_sfu_v3.sql');
const catalogMigration=read('supabase/migrations/20260912015000_call_media_catalog_active_session_v3.sql');
...
assert(catalogMigration.includes('cp.provider_session_id=t.provider_session_id'),'catalog must reject stale provider sessions');
assert(catalogMigration.includes('cp.left_at is null'),'catalog must reject departed participants');
