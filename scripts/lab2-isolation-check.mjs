...
const [
  understanding,research,webProvider,publicFallback,improvements,brief,structure,design,mockups,presentationPlan,
  workerEntry,previewWorker,
  studioJs,studioHtml,researchJs,researchHtml,improvementsJs,improvementsHtml,briefJs,briefHtml,structureJs,structureHtml,designJs,designHtml,mockupsJs,mockupsHtml,
  presentationPlannerJs,presentationJs,presentationHtml,pptxJs,mockupRenderer
]=await Promise.all([
  read('src/lab2-idea-understanding.js'),read('src/lab2-idea-research.js'),read('src/lab2-web-provider.js'),read('src/lab2-public-fetch-fallback.js'),read('src/lab2-idea-improvements.js'),read('src/lab2-idea-brief.js'),read('src/lab2-idea-structure.js'),read('src/lab2-idea-design.js'),read('src/lab2-idea-mockups.js'),read('src/lab2-presentation-plan.js'),
...
for(const [name,endpoint] of [['UNDERSTANDING',understanding],['RESEARCH',research],['IMPROVEMENTS',improvements],['BRIEF',brief],['STRUCTURE',structure],['DESIGN',design],['MOCKUPS',mockups],['PRESENTATION_PLAN',presentationPlan]]){
...
console.log('lab2-isolation-check: ok (multi-provider research + adaptive presentation remain isolated)');
