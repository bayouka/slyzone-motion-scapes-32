...
assert(worker.includes('v4.5.1-mobile-nav'),'worker health version');
assert(index.includes('assets/boot.js?build=501'),'cache bust 501');
assert(index.includes('assets/design-v5.css?v=5.0.1-mobile-nav'),'V5 design system loaded last');
...
all(boot,["const VERSION = 'v4.5.1-mobile-nav'",'syncProbeIntervalMs: Math.max(15000','fullRefreshFallbackMs: Math.max(300000','delivery-workflow-v1.js','workflow-backend-safe-v1.js','communication-workspace-v1.js','resources-workspace-v2.js','library-workspace-v1.js'],'boot contract missing');
