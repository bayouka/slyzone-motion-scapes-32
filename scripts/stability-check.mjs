...
assert(worker.includes('v4.5.6-css-prune'),'worker health version');
assert(index.includes('assets/boot.js?build=506'),'cache bust 506');
...
all(boot,["const VERSION = 'v4.5.6-css-prune'",'syncProbeIntervalMs: Math.max(15000','fullRefreshFallbackMs: Math.max(300000','delivery-workflow-v1.js','workflow-backend-safe-v1.js','communication-workspace-v1.js','resources-workspace-v2.js','library-workspace-v1.js'],'boot contract missing');
