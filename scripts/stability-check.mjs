...
assert(worker.includes('v4.5.8-nav-dead-css'),'worker health version');
assert(index.includes('assets/boot.js?build=508'),'cache bust 508');
...
all(boot,["const VERSION = 'v4.5.8-nav-dead-css'",'syncProbeIntervalMs: Math.max(15000','fullRefreshFallbackMs: Math.max(300000','delivery-workflow-v1.js','workflow-backend-safe-v1.js','communication-workspace-v1.js','resources-workspace-v2.js','library-workspace-v1.js'],'boot contract missing');
