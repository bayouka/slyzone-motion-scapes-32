...
for(const marker of [
  'ideas-v1.css?v=1.0.0',
  "ideas-v1.js?v=1.0.0"
]) assert(index.includes(marker),`index missing ${marker}`);
...
for(const marker of [
  '.ideas-v1-projects-panel',
  '.ideas-v1-layout',
  '.ideas-v1-tabs',
  '.ideas-v1-presentation',
  '@media(max-width:767px)'
]) assert(css.includes(marker),`styles missing ${marker}`);
...
for(const marker of [
  ...
  'app_private.can_access_idea',
  'app_private.can_write_idea',
  'IDEA_NOT_APPROVED',
  'already_converted',
  "app_private.rpc_create_project_with_access_v1",
  'revoke all on function public.create_idea_v1',
  'grant execute on function public.convert_idea_to_project_v1'
