...
assert(index.includes('const callV3Enabled = !forceV2 && (explicitV3 || pilotV3)'), 'pilot selection must preserve V2 rollback precedence');

console.log('Call signal isolation pilot gate: OK');
